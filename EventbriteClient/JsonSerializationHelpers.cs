...
namespace EventbriteClient
{
    ...
    {
        public const string ISO_8601_DATE_TIME_FORMAT_STRING = @"yyyy-MM-dd HH:mm:ss";

        /// <summary>
        /// Maps PropertyName to property_name per http://stackoverflow.com/a/7275039
        /// </summary>
        private class UnderscoreMappingResolver : Newtonsoft.Json.Serialization.DefaultContractResolver
        {
        ...
        public static IEnumerable<MediaTypeFormatter> GetJsonFormatters()
        {
            return new[] {
                new JsonMediaTypeFormatter {
                    SerializerSettings = new JsonSerializerSettings {
                        Converters = new List<JsonConverter> {
                            ...
                            new IsoDateTimeConverter() { DateTimeFormat = ISO_8601_DATE_TIME_FORMAT_STRING, DateTimeStyles = System.Globalization.DateTimeStyles.AssumeLocal }
                        },
        ...
        #region TimeZoneDictionarys

        private static Dictionary<string, string> windowsTimeZones = new Dictionary<string, string>()
            {
...
{ "PST8PDT", "Pacific Standard Time"}
        ...
        /// <summary>
        /// Converts a Windows <see cref="TimeZoneInfo"/> to a Region/Territory 001 TZID (Olson time zone).
        /// </summary>
        /// <returns></returns>
        /// <remarks>Only maps to the Region 001 TZID available at: http://unicode.org/repos/cldr-tmp/trunk/diff/supplemental/zone_tzid.html</remarks>
        public static string TimeZoneInfoToOlsonTimeZone(TimeZoneInfo timeZoneInfo)
        {
            string olsonTimezoneId = default(string);
            if (windowsTimeZones.TryGetValue(timeZoneInfo.Id, out olsonTimezoneId))
            {
                return olsonTimezoneId;
            }
            else
            {
                throw new InvalidTimeZoneException("No mapping exists for the given TimeZoneInfo.Id");
            }
        }
        ...
        /// From: http://stackoverflow.com/a/6144229/612166
        /// </remarks>
